    ...
    <div className="container mx-auto px-4 py-8 font-sans">
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-1 mt-12">
          {/* Mobile View: Only Previous/Next and Current Page */}
          <div className="md:hidden flex items-center gap-2">
            <button
              onClick={() => handlePageChange(currentPage - 1)}
              disabled={currentPage === 1}
              className="px-3 py-2 bg-purple-500 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-purple-600 transition-colors duration-200 text-sm whitespace-nowrap"
            >
              Previous
            </button>
          ...
          <div className="hidden md:flex items-center gap-1 overflow-x-auto pb-2">
            ...
            <button
              ...
              className={`px-2 py-2 rounded-lg transition-colors duration-200 text-sm ${
                currentPage === 1 ? 'bg-purple-700 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
            >
              1
            </button>
